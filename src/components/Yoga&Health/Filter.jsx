...
const Filter = () => {
  return (
    <div className="border-2 border-pink-700  px-5 py-5 text-white font-cinzel text-xl flex flex-col gap-4 rounded-xl">
      ...
      <div className="space-y-3">
        <label for="date">Choose a car:</label>

        <select name="date" id="date" className="text-gray-900 border-0 outline-none rounded-xl text-sm px-4 py-3">
...
<button className="flex items-center mt-5 px-4 py-2 bg-gradient-to-r from-fuchsia-600  to-pink-600 text-center rounded-full border-2 border-sky-400 font-medium gap-3"><p>result filter</p>
<svg className="w-5" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return(
    <div className="space-y-3">
        ...
        <input
          ...
          className="border-0 outline-none rounded-xl text-sm px-4 py-3"
        />
        </div>
  )
}
