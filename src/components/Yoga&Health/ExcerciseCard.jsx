...
const ExcerciseCard = ({daysLeft,img, exercise, instructor, date, location }) => {
  return (
    ...
    className="w-5"
          ...
          <p className="text-sm text-pink-600 font-semibold">{location}</p>
        </div>

        <button class="bg-gradient-to-r from-fuchsia-500 to-pink-600 w-fit px-3 py-2 rounded-xl text-white font-medium mx-auto">
          Book Now
        </button>
      </div>
    </div>
