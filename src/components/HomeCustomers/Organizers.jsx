          ...
          {organizers.map((organizer) => (
            <div class="card bg-dark text-white w-72 h-96 flex ">
              ...
              <div class="card-img-overlay  border h-fit text-black bg-white w-3/5 px-0 py-2 mt-auto mx-auto">
                <h5 class="card-title font-cinzel text-xl font-bold">
                  {organizer.name}
                </h5>
                <p class="card-text font-medium ">{organizer.profession}</p>
              </div>
            </div>
          ))}
        </div>
