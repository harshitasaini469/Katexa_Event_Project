...
const Hero = () => {
  return (
    <div className="relative z-10 w-screen h-screen font-cinzel  ">
      ...
      >
        <div className="space-y-5 w-1/3 text-center ml-28 ">
        <p className="text-5xl font-semibold">
          Embarce the Spectacular Unlaeash your Eventful Journey
          </p>
          <button className="bg-gradient-to-r from-fuchsia-500 to-pink-600 px-4 py-2 rounded-xl text-3xl font-medium">
            Explore 
          </button>
        </div>
