  ...
  return (
    <nav class="fixed  w-full z-40 top-3 left-0 font-cinzel py-2 px-3  ">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto text-lg ">
        ...
        <div
          class={`"items-center justify-between  md:bg-transparent w-full text-sm md:text-base md:flex md:text-white md:w-auto md:order-1" ${isMenuOpen?'block transform transition-all duration-300 ease-in-out bg-white text-black rounded-lg':'hidden'}`}
          id="navbar-sticky"
        >
